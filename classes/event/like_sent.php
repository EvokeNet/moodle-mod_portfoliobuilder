...
class like_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventlikesent', 'mod_portfoliobuilder');
    }
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'portfoliobuilder_reactions';
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'portfoliobuilder_reactions', 'restore' => 'portfoliobuilder_reaction');
    }
}
